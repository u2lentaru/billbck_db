create or replace function func_create_user (pv_username name, pv_password text) returns boolean as 
$$
declare
...
begin
  ...
  begin
      select count(*) into ln_count from pg_user where usename = pv_username;
  exception
